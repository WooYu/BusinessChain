 ...
 * 会员专区商品
 */
public class MemberAreaGoodsAdapter extends DelegateAdapter.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        return new HotSaleViewHolder(LayoutInflater.from(mContext).inflate(R.layout.home_item_member_goods, viewGroup, false));
    }
