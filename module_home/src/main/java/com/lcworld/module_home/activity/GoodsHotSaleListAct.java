...
import com.lcworld.module_home.databinding.HomeActivityGoodslistHotsaleBinding;
import com.lcworld.module_home.viewmodel.SearchGoodsResultViewModel;

/**
 * 自由购
 */
public class GoodsHotSaleListAct extends BaseActivityEnhance<HomeActivityGoodslistHotsaleBinding, SearchGoodsResultViewModel> {
    ...
    public int initContentView(Bundle bundle) {
        return R.layout.home_activity_goodslist_hotsale;
    }
