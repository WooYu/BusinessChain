...
import com.lcworld.module_account.databinding.AccountActivityBrowseTextBinding;
import com.lcworld.module_account.viewmodel.BrowseTextViewModel;

/**
 * 只加载文本的activity
 * 0拼团客服电话 10关于我们 20拼团合同 30拼团支付协议 40 常见问题 50注册协议 60成长值介绍
 */
public class BrowseTextActivity extends BaseActivityEnhance<AccountActivityBrowseTextBinding, BrowseTextViewModel> {
    ...
    public int initContentView(Bundle bundle) {
        return R.layout.account_activity_browse_text;
    }
